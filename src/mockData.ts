...
<Tabs variant="underline" orientation="horizontal">
  <TabList>
    <Tab index={0} label="Label 1" badgeLabel="New" badgeVariant="positive" theme="default"/>
...
<Tabs variant={tabsGeneratedData.tabsVariant} 
  orientation={tabsGeneratedData.orientation} 
  theme={tabsGeneratedData.theme}>
  <TabList>
